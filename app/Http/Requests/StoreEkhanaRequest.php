...
class StoreEkhanaRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'ed_quali_id' => 'required|integer|exists:education_qualifications,id',
            'phone' => 'required|string|unique:ekhanas,phone|digits:11',
            'spouse_name' => 'required|string|max:255',
            'mother_name' => 'required|string|max:255',
            'm_male' => 'nullable|integer',
            'm_female' => 'nullable|integer',
            'm_child' => 'nullable|integer',
            'dob' => 'required|date',
            ...
            'yearly_house_rent' => 'required|integer',
            ...
            'house_struc_id.*' => 'required|integer',
        ];
    }
