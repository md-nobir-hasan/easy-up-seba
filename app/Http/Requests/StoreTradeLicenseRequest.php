...
class StoreTradeLicenseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'present_address.country' => 'required|string|max:100|min:2',
            'permanent_address.country' => 'required|string|max:100|min:2',
            'business_address.country' => 'required|string|max:100|min:2',
            ...
            'present_address.ward_number' => 'nullable|string|max:255|min:2',
            'permanent_address.ward_number' => 'nullable|string|max:255|min:2',
            'business_address.ward_number' => 'nullable|string|max:255|min:2',
        ];
    }
}
