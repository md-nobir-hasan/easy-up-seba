...
usePage().props.permissions.forEach(function(val,key){
    if(val.module.name == 'User' && val.role_id == user.role_id){
    ...
    <AppLayout title="User">
        <!-- <div class="py-12"> -->
            <!-- <div class="max-w-7xl mx-auto sm:px-6 lg:px-8"> -->
                <!-- <div class="bg-white overflow-hidden shadow-2xl p-8 sm:rounded-lg"> -->
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <SucMesgShow :message="$page.props.flash.suc_msg"></SucMesgShow>
                        <div class="bg-white flex justify-between p-4">
                            <h2 class="float-left text-4xl font-extrabold">User</h2>
                            <Link :href="route('admin.user.user.create')">
                            ...
                            <tbody>
                                <tr v-for="(value, key) in users"
                                    ...
                                    <td v-if="ncheck('edit') || ncheck('delete')" class="px-6 py-4 flex item-center justify-center">
                                        ...
                                        <Link v-if="ncheck('delete') && ($page.props.auth.user.role_id != 1)" :href="route('admin.single.delete',[value.id,'User'])" class="font-medium ml-2 text-red-600 dark:text-blue-500 hover:underline">
