...
const mdata = ref(usePage().props.users);
                            ...
                            <tbody>
                                <tr v-for="(value, key) in mdata" :key="key"
                                    ...
                                    <td v-if="ncheck('edit') || ncheck('delete')" class="px-6 py-4 flex item-center justify-center">
                                        ...
                                        <button @click="deleting(value.id,'User')"  v-if="ncheck('delete')" class="font-medium ml-2 text-red-600 dark:text-blue-500 hover:underline">
