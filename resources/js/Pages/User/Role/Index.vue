...
usePage().props.permissions.forEach(function(val,key){
    if(val.module.name == 'Role' && val.role_id == user.role_id){
                ...
                <!-- <div class="bg-white overflow-hidden shadow-2xl p-8 sm:rounded-lg"> -->
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        ...
                        <div class="bg-white flex justify-between p-4">
                            <h2 class="float-left text-4xl font-extrabold">Role</h2>
                            <Link :href="route('admin.user.role.create')">
                            ...
                            <tbody>
                                <tr v-for="(value, key) in roles"
                                    ...
                                    <td class="px-6 py-4 flex item-center justify-center" v-if="ncheck('edit') || ncheck('delete')">
                                        ...
                                        <Link v-if="ncheck('delete')" :href="route('admin.single.delete',[value.id,'Role'])" class="font-medium ml-2 text-red-600 dark:text-blue-500 hover:underline">
