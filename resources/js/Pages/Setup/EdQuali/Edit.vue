...
const submit = () => {
    form.put(route('admin.setup.education-qualification.update',usePage().props.mdata.id), {
    ...
    <AppLayout title="শিক্ষাগত যোগ্যতা">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="bg-white flex justify-between p-4">
                <h2 class="float-left text-3xl font-extrabold">শিক্ষাগত যোগ্যতা আপডেট</h2>
                <Link :href="route('admin.setup.education-qualification.index')">
