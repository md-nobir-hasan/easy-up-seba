...
usePage().props.permissions.forEach(function(val,key){
    if(val.module.name == 'Union' && val.role_id == user.role_id){
    ...
    <AppLayout title="ইউনিয়ন">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <div class="bg-white flex justify-between p-4">
                <h2 class="float-left text-4xl font-extrabold">ইউনিয়ন</h2>
                <Link :href="route('admin.setup.union.create')">
                ...
                <tbody>
                    <tr v-for="(value, key) in mdata" :key="key"
                        ...
                        <td class="px-6 py-4 flex item-center justify-center" v-if="ncheck('edit') || ncheck('delete')">
                            <Link v-if="ncheck('edit')" :href="route('admin.setup.union.edit', [value.id])"
