...
const submit = () => {
    form.post(route('admin.setup.union.store'), {
            ...
            <FormLayout class="bg-white">
                ...
                <form @submit.prevent="submit" class="bg-white p-8 text-2lg">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="district_id" @change="upazilaFetch" v-model="form.district_id" :disabled="ddisable" class="border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    ...
                    <div>
                        <InputLabel for="name" value="ইউনিয়নের নাম" />
                        <TextInput
                            id="name"
                            v-model="form.name"
                            type="text"
