...
const form = useForm({
    name: usePage().props.union.name,
    code: usePage().props.union.code,
    division_id: usePage().props.union.division_id,
    district_id: usePage().props.union.district_id,
    upazila_id: usePage().props.union.upazila_id,
});

const submit = () => {
    form.put(route('admin.setup.union.update',[usePage().props.union.id]), {
