...
usePage().props.permissions.forEach(function(val,key){
    if(val.module.name == 'Profession' && val.role_id == user.role_id){
...
<template>
    <AppLayout title="পেশা">
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <SucMesgShow :message="$page.props.flash.suc_msg"></SucMesgShow>
                        <div class="bg-white flex justify-between p-4">
                            <h2 class="float-left text-4xl font-extrabold">পেশা</h2>
                            <Link :href="route('admin.setup.profession.create')">
                            ...
                            <tbody>
                                <tr v-for="(value, key) in data"
                                    ...
                                    <td class="px-6 py-4 flex item-center justify-center" v-if="ncheck('edit') || ncheck('delete')">
                                        <Link v-if="ncheck('edit')" :href="route('admin.setup.profession.edit',[value.id])" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                        ...
                                        <Link v-if="ncheck('delete')" :href="route('admin.single.delete',[value.id,'Profession'])" class="font-medium ml-2 text-red-600 dark:text-blue-500 hover:underline">
