...
const submit = () => {
    form.put(route('admin.setup.profession.update',usePage().props.mdata.id), {
    ...
    <AppLayout title="পেশা">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="bg-white flex justify-between p-4">
                <h2 class="float-left text-3xl font-extrabold">পেশা আপডেট</h2>
                <Link :href="route('admin.setup.profession.index')">
