    ...
    <AppLayout title="অর্থ-বছর">
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        ...
                        <div class="bg-white flex justify-between p-4">
                            <h2 class="float-left text-4xl font-extrabold">অর্থ-বছর</h2>
                            <Link :href="route('admin.setup.financial-year.create')">
                            ...
                            <tbody>
                                <tr v-for="(value, key) in mdata" :key="key"
                                    ...
                                    <td class="px-6 py-4 flex item-center justify-center" v-if="ncheck('edit') || ncheck('delete')">
                                        <Link v-if="ncheck('edit')" :href="route('admin.setup.financial-year.edit',[value.id])" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                        ...
                                        <button @click="deleting(value.id,'FinancialYear')"  v-if="ncheck('delete')" class="font-medium ml-2 text-red-600 dark:text-blue-500 hover:underline">
