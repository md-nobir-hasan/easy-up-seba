...
const mdata = ref(usePage().props.villages);
    ...
    <AppLayout title="গ্রাম">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <div class="bg-white flex justify-between p-4">
                ...
                <Link :href="route('admin.setup.village.create')">
            ...
            <table class="w-full text-md text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr v-for="(value, key) in mdata" :key="key"
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            {{ value.word.name }}({{ value.word.code }})
                        </th>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        ...
                        <td class="px-6 py-4 flex item-center justify-center" v-if="ncheck('edit') || ncheck('delete')">
                            <Link v-if="ncheck('edit')" :href="route('admin.setup.village.edit', [value.id])"
                            ...
                            <button @click="deleting(value.id,'Village')"  v-if="ncheck('delete')" class="font-medium ml-2 text-red-600 dark:text-blue-500 hover:underline">
