    ...
    <AppLayout title="বাজার">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <div class="bg-white flex justify-between p-4">
                <h2 class="float-left text-4xl font-extrabold">বাজার</h2>
                <Link :href="route('admin.setup.bazar.create')">
                ...
                <tbody>
                    <tr v-for="(value, key) in mdata" :key="key"
                        ...
                        <td class="px-6 py-4 flex item-center justify-center" v-if="ncheck('edit') || ncheck('delete')">
                            <Link v-if="ncheck('edit')" :href="route('admin.setup.bazar.edit', [value.id])"
                            ...
                            <button @click="deleting(value.id,'Bazar')"  v-if="ncheck('delete')" class="font-medium ml-2 text-red-600 dark:text-blue-500 hover:underline">
