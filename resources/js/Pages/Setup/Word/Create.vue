...
const submit = () => {
    form.post(route('admin.setup.word.store'), {
...
<template>
    <AppLayout title="ওয়ার্ড">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="bg-white flex justify-between p-4">
                <h2 class="float-left text-3xl font-extrabold">ওয়ার্ড যোগ</h2>
                <Link :href="route('admin.setup.word.index')">
                ...
                <form @submit.prevent="submit" class="bg-white p-8 text-2lg">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="district_id" @change="upazilaFetch" v-model="form.district_id" :disabled="ddisable"
                            ...
                            class="border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="union_id" v-model="form.union_id" :disabled="uniondisable"
                         ...
                         :class="[uniondisable ? 'disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none invalid:border-pink-500 invalid:text-pink-600' : '']"
                         required>
