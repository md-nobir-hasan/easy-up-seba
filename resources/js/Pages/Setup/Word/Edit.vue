...
const form = useForm({
    name: usePage().props.word.name,
    code: usePage().props.word.code,
    division_id: usePage().props.word.division_id,
    district_id: usePage().props.word.district_id,
    upazila_id: usePage().props.word.upazila_id,
    union_id: usePage().props.word.union_id,
});

const submit = () => {
    form.put(route('admin.setup.word.update',[usePage().props.word.id]), {
            ...
            <FormLayout class="bg-white">
                ...
                <form @submit.prevent="submit" class="bg-white p-8 text-2lg">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="union_id" v-model="form.union_id" :disabled="uniondisable || updisable || ddisable"
                         class="border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
