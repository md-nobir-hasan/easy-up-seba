        ...
        <div class="w-[10in] m-auto">
            ...
            <div class="">
                ...
                <div class="flex items-center justify-between mt-4 pl-[75px]">
                    <div class="">
                        <h4><span class="font-bold">অর্থ-বছর :</span> {{ekhana.f_year.from + '-' +ekhana.f_year.to}}</h4>
                        <!-- <h4>গ্রাহক কপি</h4> -->
                    </div>
                    <div class="pl-8">
                    ...
                    <table class="w-[100%] bg-[#ffc8c8d9] text-center border-collapse border border-[black] p-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border border-[black] p-2">{{ previous_arrears }}</td>
