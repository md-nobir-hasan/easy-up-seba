...
<template>
    <AppLayout title="সমস্ত বিল প্রিন্ট (পুরাতন)">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <SucMesgShow :message="$page.props.flash.suc_msg"></SucMesgShow>
            <div class="bg-white flex justify-between p-4">
                <h2 class="float-left text-4xl font-extrabold">সমস্ত বিল প্রিন্ট (পুরাতন)</h2>
            </div>
            <!-- <button @click="sweetsuc">sldfjsdkf</button> -->
            <div class="mt-4 mb-2 p-4 bg-white">
                <form :action="route('admin.tax.bill.print.all.old.show')" method="GET" target="_blank" class="bg-[#008494db] text-[white] m-auto  rounded-lg p-6 pb-[2px] text-2lg max-w-md max-sm:max-w-sm">
